 ...
 * 修改为未上课程的提示信息
 */
public class FirstCheckAdapter extends RecyclerView.Adapter<FirstCheckAdapter.VH> {
    ...
    public FirstCheckAdapter(Context context) {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_bxz_home_firstcheck, parent, false);
    ...
    public class VH extends RecyclerView.ViewHolder {
        public TextView checkinmsg;//获取学号
        public TextView checkinstatus;//获取姓名


        public VH(View itemView) {
            super(itemView);
            checkinmsg = (TextView) itemView.findViewById(R.id.s_check_num);
            checkinstatus = (TextView) itemView.findViewById(R.id.s_check_name);
        }
    }
}
